...
console.log("Total number chars available into this string variables - greet");
var greetLenth = greet.length;
console.log(greetLenth);
...
var charAtLastindex = greet.charAt(greetLenth - 1);
